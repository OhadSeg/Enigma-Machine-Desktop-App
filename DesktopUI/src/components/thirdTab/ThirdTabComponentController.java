...
public class ThirdTabComponentController {
    ...
    @FXML
    private ComboBox<BruteForceLevel> difficultyLevelComb;
    @FXML
    ...
    public void initialize() {
        ...
        ArrayList<BruteForceLevel> difficultyLevel = new ArrayList<>();
        difficultyLevel.add(BruteForceLevel.EASY);
        difficultyLevel.add(BruteForceLevel.MEDIUM);
        difficultyLevel.add(BruteForceLevel.HARD);
        difficultyLevel.add(BruteForceLevel.IMPOSSIBLE);
        ObservableList<BruteForceLevel> difficultyLevelObservList = FXCollections.observableList(difficultyLevel);
